    ...
    <tbody>
      ...
      include_once("db_functions.php"); 
        if(isset($_GET['delete'])){
          ...
          $u_id = $_SESSION['u_id'];
          $s = "DELETE FROM u_test_num WHERE id=".$deleteid;
          $n = queryMysql($s);
        ...
        $result = queryMysql($query);
         while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
            $sorov = "select count(id) from u_tests where test_num=".$row['id']."";
            ...
            echo "<td><a class='btn btn-success' href='/admin/u_testcatid.php?testcatid=".$row['id']."'</a>Testlarga o'tish</td>";
