    ...
    <tbody>
      <?php
        ...
        if(isset($_GET['delete'])){
          ...
          $sorov = "DELETE from tests where id=".$deleteid." AND created_by=".$_SESSION['u_id'];
      ...
      ///real escape ish bermadi :(
        ...
        $query = "select * from tests where test_num=".$test_num." AND created_by=".$_SESSION['u_id'];
        $result = queryMysql($query);
         while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
          $k++;
            ...
            echo "<td><a class='btn btn-success' href='/admin/test_view.php?testno=".$row['id']."&question=".$row['question']."&item1=".$row['item1']."&item2=".$row['item2']."&item3=".$row['item3']."&trueitem=".$row['trueitem']." '</a>Taxrirlash</td>";
