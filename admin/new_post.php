 ...
 <?php 
            ...
            if(isset($_GET['question'])){
               $question=$item1=$item2=$item3=$trueitem=$test_num = "";
                ...
                $sorov = "INSERT INTO  tests (
                question , item1 , item2 , item3 ,
                trueitem , test_num,created_by)
                VALUES ('".$question."',  '".$item1."', '".$item2."',  
                '".$item3."','".$trueitem."', '".$test_num."','".$created_by."');"; 
          ...
          <section class="wrapper">
            ...
            ?>
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="GET" action="new_post.php">
